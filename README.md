...
This repository is a resource for [this blog post](https://nikolajbjoernager.dk/linux-cpp-networking/) I wrote.

It breaks down how to do basic TCP-based networking with byte streams using network to host order and the other way around.\
